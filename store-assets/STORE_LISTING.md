...
AcademyLens includes thirteen premium glossary packs with 100+ OpenAI Academy/OpenAI Docs core terms each: German, Spanish, French, Hindi, Indonesian, Italian, Japanese, Korean, Brazilian Portuguese, Russian, Vietnamese, Simplified Chinese, and Traditional Chinese. Korean is the first reviewed pack; the other premium packs are AI-drafted beta glossaries that need X translation cross-checks, community review, and native review. Other languages use machine translation with protected-term preservation.
...
Page text selected for translation is sent to Google Translate. The extension does not run a server, does not load remote AI scripts in v1, and does not collect personal data for the developer.
