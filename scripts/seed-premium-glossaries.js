...
const targetTerms = {
  ...
  it: {
    ...
    "reviewing outputs": "revisióne degli output",
    "review point": "punto di revisióne",
    "review points": "punti di revisióne",
  ...
  "pt-BR": {
    ...
    "reviewing outputs": "revisao de saídas",
    ...
    "repeatable ways of working": "formas de trabalho repetiveis",
...
function buildDraftGlossary(localeRecord, sourceGlossary) {
  ...
  const terms = sourceGlossary.terms.map((term) => {
    ...
    return {
      ...term,
      target,
      note: `${DRAFT_NOTE} Source rationale: ${term.note}`
    };
  });
